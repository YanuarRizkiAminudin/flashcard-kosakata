...
<div id="qv">
  ...
  <div class="card" id="card" onclick="reveal()">
    ...
    <div class="ans" id="ans" style="display:none">
      ...
      <table class="vtable">
        <thead><tr><th>V1</th><th>V2 (Past)</th><th>V3 (Past P.)</th><th>V-ing</th></tr></thead>
        <tbody><tr><td class="v1" id="av1"></td><td class="v2" id="av2"></td><td class="v3" id="av3"></td><td class="ving" id="aving"></td></tr></tbody>
      </table>
      <div class="exbox"><div class="exlabel">&#128218; CONTOH KALIMAT</div><div class="extext" id="extext"></div></div>
      <div class="notebox" id="notebox" style="display:none"><div class="notelabel">&#9888; CATATAN GRAMMAR</div><div class="notetext" id="notetext"></div></div>
    </div>
  </div>
...
<div id="rv" style="display:none">
  <div class="res">
    ...
    <div id="rlw" style="display:none"><div class="rlist-wrap"><div class="rlist-ttl">Kartu untuk ronde berikutnya</div><div class="rlist" id="rl"></div></div></div>
...
js_data = open('verb_js.txt', encoding='utf-8').read()
...
function fullRestart(){
  ...
  deck=sh(src);
  document.getElementById("tsub").textContent=(curCat==="ALL"?"Semua kata kerja -- "+deck.length+" kartu":LABELS[curCat]+" -- "+deck.length+" kartu");
  go();
}
function go(){
